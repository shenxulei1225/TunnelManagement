package com.cheers.arch.module.system.controller.admin.sms.vo.template;
...
import com.cheers.arch.module.system.enums.DictTypeConstants;
...
public class SmsTemplateRespVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "cheers")
    @ExcelProperty("模板名称")
    private String name;
