package com.cheers.framework.mq.core.job;

import com.cheers.framework.mq.core.RedisMQTemplate;
import com.cheers.framework.mq.core.stream.AbstractRedisStreamMessageListener;
...
public class RedisStreamMessageCleanupJob {
    ...
    private void execute() {
        ...
        listeners.forEach(listener -> {
            try {
                // 使用 XTRIM 命令清理消息，只保留最近的 MAX_COUNT 条消息
