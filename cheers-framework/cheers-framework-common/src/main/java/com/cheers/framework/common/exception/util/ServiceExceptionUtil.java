package com.cheers.framework.common.exception.util;
...
public class ServiceExceptionUtil {
    ...
    public static ServiceException invalidParamException(String messagePattern) {
        return exception0(1001002, messagePattern);
    }
