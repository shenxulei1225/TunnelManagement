...
import com.cheers.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.cheers.framework.websocket.core.listener.WebSocketMessageListener;
import com.cheers.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.cheers.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import com.cheers.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.cheers.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.cheers.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.cheers.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.cheers.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.cheers.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.cheers.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.cheers.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.cheers.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.cheers.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.cheers.framework.websocket.core.session.WebSocketSessionManager;
import com.cheers.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
public class WebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "cheers.websocket", name = "sender-type", havingValue = "local", matchIfMissing = true)
    ...
    public class RedisWebSocketMessageSenderConfiguration {
        ...
        public RedisWebSocketMessageSender redisWebSocketMessageSender(WebSocketSessionManager sessionManager,
            ...
            return new RedisWebSocketMessageSender(sessionManager, redisTemplate);
        }
    ...
    public class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${cheers.websocket.rocketmq.topic}") String topic) {
    ...
    public class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${cheers.websocket.rabbitmq.exchange}") String exchange) {
    ...
    public class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${cheers.websocket.kafka.topic}") String topic) {
