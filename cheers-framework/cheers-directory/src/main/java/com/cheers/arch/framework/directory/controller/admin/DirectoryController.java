package com.cheers.arch.framework.directory.controller.admin;

import com.cheers.arch.framework.common.pojo.CommonResult;
import com.cheers.arch.framework.directory.controller.admin.vo.*;
import com.cheers.arch.framework.directory.convert.DirectoryConvert;
...
public class DirectoryController {
    ...
    public CommonResult<Long> createDirectory(@Valid @RequestBody DirectoryCreateReqVO createReqVO) {
        DirectoryDO directory = DirectoryConvert.INSTANCE.convert(createReqVO);
        return CommonResult.success(directoryService.createDirectory(directory));
    }
    ...
    public CommonResult<Boolean> updateDirectory(@Valid @RequestBody DirectoryUpdateReqVO updateReqVO) {
        DirectoryDO directory = DirectoryConvert.INSTANCE.convert(updateReqVO);
