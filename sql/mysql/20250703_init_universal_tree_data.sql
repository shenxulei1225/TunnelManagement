...
-- 插入树配置数据
INSERT INTO system_tree_config (tree_type, tree_name, description, allowed_data_types, max_level, node_name_label, node_code_label, sort_type, status, config_json) VALUES
...
-- 插入数据类型元数据
INSERT INTO system_data_type_meta (data_type, data_name, description, icon, color, table_name, id_field, name_field, status_field, config_json, status) VALUES
